...
if ack_alerts_request.status_code != requests.codes.ok:
    print('[!] Acknowledging alerts failed.')
    exit()
...
if fetch_alerts_request.status_code != requests.codes.ok:
    print('[!] Fetching acknowledged alerts failed.')
    exit()
...
if del_alerts_request.status_code != requests.codes.ok:
    print('[!] Deleting acknowledged alerts failed.')
    exit()
